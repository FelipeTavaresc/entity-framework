...
CREATE TABLE [Post] (
    ...
    [LastUpdateDate] SMALLDATETIME NOT NULL DEFAULT '2024-07-18T21:34:45.5556169Z',
    [CategoryId] int NULL,
    [AuthorId] int NULL,
...
VALUES (N'20240718213445_InitialCreation', N'5.0.0');
GO
...
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[User]') AND [c].[name] = N'GitHub');
...
ALTER TABLE [Post] ADD DEFAULT '2024-07-18T21:45:31.6651015Z' FOR [LastUpdateDate];
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20240718214531_RemovendoCampoGitHub', N'5.0.0');
GO
